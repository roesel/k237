...
class Ui_sweepergui(object):
    def setupUi(self, sweepergui):
        ...
        self.formLayout_2.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.groupBox_4)
        ...
        self.formLayout_2.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.groupBox_5)

...
if len(sys.argv) != 9:
    try:
        if sys.argv[1] == '--help':
            print(' Usage: python nmiv_sweep.py START_V STOP_V NEGATIVE #STEP RETURN RANGE[0-4] DELAY NAME')
        else:
...
try:
    ...
    number_of_points = float(sys.argv[4])
...
inst.write("G5,2,2X")
# Create sweep list
sweep_command = "Q1,{},{},{},{},{}X".format(start_voltage, stop_voltage, number_of_points, rng, delay)
print(sweep_command)

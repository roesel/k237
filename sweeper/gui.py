...
class Ui_sweepergui(object):
    def setupUi(self, sweepergui):
        ...
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.delaySpinBox)
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.decadeComboBox)
